...
export function registerNginxConfigTools(server: McpServer) {
  server.tool(
          ...
          content: [
            {
              type: "text" as const,
              text: JSON.stringify(
                { action: "upgrade_required", instructions: "The nginx_optimize tool requires a Pro subscription. Please upgrade to access Nginx optimization features." },
                null,
                2
              ),
            },
