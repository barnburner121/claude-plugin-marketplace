...
export function registerK8sManifestTools(server: McpServer) {
  server.tool(
          ...
          content: [
            {
              type: "text" as const,
              text: JSON.stringify(
                { action: "upgrade_required", instructions: "The k8s_security_audit tool requires a Pro subscription. Please upgrade to access security auditing features." },
                null,
                2
              ),
            },
