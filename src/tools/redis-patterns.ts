...
export function registerRedisPatternsTools(server: McpServer) {
  server.tool(
    "redis_setup_caching",
          ...
          content: [
            {
              type: "text" as const,
              text: JSON.stringify(
                { action: "upgrade_required", instructions: "The redis_setup_pubsub tool requires a Pro subscription. Please upgrade to access Redis Pub/Sub setup." },
                null,
                2
              ),
            },
