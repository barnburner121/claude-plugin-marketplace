...
export function registerSeedGenTools(server: McpServer) {
  server.tool(
    "seed_generate_data",
          ...
          content: [
            {
              type: "text" as const,
              text: JSON.stringify(
                { action: "upgrade_required", instructions: "The seed_reset_script tool requires a Pro subscription. Please upgrade to access database reset script generation." },
                null,
                2
              ),
            },
