...
export function registerRestDesignerTools(server: McpServer) {
  server.tool(
          ...
          content: [
            {
              type: "text" as const,
              text: JSON.stringify(
                { action: "upgrade_required", instructions: "The rest_validate_conventions tool requires a Pro subscription. Please upgrade to access REST convention validation." },
                null,
                2
              ),
            },
