...
export function registerI18nExtractorTools(server: McpServer) {
  server.tool(
            ...
            text: JSON.stringify(
              {
                ...
                instructions:
                  "Scan the provided source code and identify all hardcoded user-facing strings including UI labels, error messages, button text, placeholder text, tooltips, and notification messages. Exclude technical strings like log messages, API endpoints, and configuration keys. Generate a translation key for each string following a dot-notation convention (e.g., 'common.buttons.submit'). Output a JSON translation file and the modified source code with strings replaced by translation function calls.",
              },
              null,
              2
            ),
              ...
              text: JSON.stringify(
                {
                  ...
                  instructions:
                    "This tool requires a Pro subscription. Upgrade to Pro to automatically generate translations for your extracted strings into multiple target languages with context-aware accuracy.",
                },
                null,
                2
              ),
