...
export function registerFormBuilderTools(server: McpServer) {
  server.tool(
    "form_from_schema",
              ...
              text: JSON.stringify(
                {
                  ...
                  instructions:
                    "This tool requires a Pro subscription. Upgrade to Pro to generate complete, production-ready form components with state management, validation, accessibility, and advanced features like multi-step forms and autosave.",
                },
                null,
                2
              ),
