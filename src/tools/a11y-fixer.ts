...
export function registerA11yFixerTools(server: McpServer) {
  server.tool(
    "a11y_scan_html",
              ...
              text: JSON.stringify(
                {
                  ...
                  instructions:
                    "This tool requires a Pro subscription. Upgrade to Pro to generate comprehensive accessibility audit reports with detailed remediation guidance and compliance summaries.",
                },
                null,
                2
              ),
