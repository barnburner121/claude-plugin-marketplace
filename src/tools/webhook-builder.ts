...
export function registerWebhookBuilderTools(server: McpServer) {
  server.tool(
          ...
          content: [
            {
              type: "text" as const,
              text: JSON.stringify(
                { action: "upgrade_required", instructions: "The webhook_add_signatures tool requires a Pro subscription. Please upgrade to access webhook signature security." },
                null,
                2
              ),
            },
