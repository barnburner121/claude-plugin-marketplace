...
export function registerDataAnonymizerTools(server: McpServer) {
  server.tool(
    "anon_detect_pii",
          ...
          content: [
            {
              type: "text" as const,
              text: JSON.stringify(
                { action: "upgrade_required", instructions: "The anon_create_script tool requires a Pro subscription. Please upgrade to access anonymization pipeline scripts." },
                null,
                2
              ),
            },
