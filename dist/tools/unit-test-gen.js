...
export function registerUnitTestGenTools(server) {
    server.tool("test_generate_unit", "Generate unit tests for functions, classes, or modules from source code", {
            ...
            content: [
                {
                    ...
                    text: JSON.stringify({
                        ...
                        instructions: "Analyze the provided source code and generate comprehensive unit tests. Cover all public functions and methods with tests for expected behavior, return values, and basic error handling. Use the specified test framework conventions and include proper setup/teardown. Organize tests in describe/it blocks with clear test names.",
                    }, null, 2),
                },
            ],
        };
    });
    server.tool("test_generate_edge_cases", "Generate edge case and boundary condition tests for source code", {
            ...
            content: [
                {
                    ...
                    text: JSON.stringify({
                        ...
                        instructions: "Analyze the provided source code and identify all edge cases, boundary conditions, and potential failure points. Generate tests for null/undefined inputs, empty collections, maximum/minimum values, type coercion issues, concurrent access scenarios, and off-by-one errors. Each test should have a descriptive name explaining the edge case being tested.",
                    }, null, 2),
                },
            ],
        };
    });
    server.tool("test_generate_mocks", "Generate mock objects, stubs, and test fixtures for dependencies (Pro)", {
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            instructions: "This tool requires a Pro subscription. Upgrade to Pro to automatically generate mock objects, stubs, and test fixtures for your dependencies.",
                        }, null, 2),
                    },
                ],
            };
