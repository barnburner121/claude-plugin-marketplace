...
export function registerPythonDjangoTools(server) {
    server.tool("scaffold_django_project", "Generate a Django project with production-ready settings structure", {
    ...
    server.tool("generate_django_app", "Generate a Django app with models, views, and URL configuration", {
    ...
    server.tool("generate_django_settings", "Generate advanced Django settings with caching, celery, and security (Pro feature)", {
