...
export function registerPerfPilotTools(server) {
    // Tool 1: Generate load test script
    server.tool("perf_generate_load_test", "Generate a comprehensive load test script for your application endpoints", {
    ...
    server.tool("perf_analyze_bottlenecks", "Scan codebase for common performance anti-patterns and bottlenecks", {
    ...
    server.tool("perf_create_budget", "Create a performance budget configuration with CI/CD enforcement (Pro feature)", {
        app_type: z
