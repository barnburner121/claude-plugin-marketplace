...
export function registerViteConfigTools(server) {
    server.tool("generate_vite_config", "Generate a Vite configuration for any frontend framework", {
    ...
    server.tool("generate_vite_plugins", "Generate custom Vite plugin configurations for build optimization", {
    ...
    server.tool("generate_vite_ssr_config", "Generate Vite SSR configuration with streaming and hydration (Pro feature)", {
