...
export function registerPwaBuilderTools(server) {
    server.tool("pwa_generate_manifest", "Generate a web app manifest file with icons, theme colors, and display settings", {
    ...
    server.tool("pwa_generate_sw", "Generate a service worker with caching strategies and lifecycle management", {
    ...
    server.tool("pwa_add_offline", "Add offline support with background sync, IndexedDB storage, and fallback pages (Pro)", {
