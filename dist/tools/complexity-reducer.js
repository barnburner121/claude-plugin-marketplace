...
export function registerComplexityReducerTools(server) {
    server.tool("complexity_analyze", "Analyze cyclomatic complexity of functions and identify overly complex code", {
    ...
    server.tool("complexity_suggest_simplifications", "Suggest specific refactoring strategies to reduce complexity", {
    ...
    server.tool("complexity_report", "Generate a full complexity analysis report with trends (Pro feature)", {
