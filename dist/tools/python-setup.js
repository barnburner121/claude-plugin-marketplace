...
export function registerPythonSetupTools(server) {
    server.tool("generate_pyproject_toml", "Generate a pyproject.toml file with build system, dependencies, and project metadata", {
    ...
    server.tool("setup_python_venv", "Generate commands and configuration for Python virtual environment setup", {
    ...
    server.tool("configure_python_linting", "Generate linting and formatting configuration for a Python project (Pro feature)", {
