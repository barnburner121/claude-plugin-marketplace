...
export function registerDuplicationHunterTools(server) {
    server.tool("dup_find_similar_blocks", "Find similar code blocks across the codebase that could be consolidated", {
    ...
    server.tool("dup_find_copy_paste", "Detect exact or near-exact copy-paste code across files", {
        directory: z.string().describe("Project directory to scan"),
    ...
    server.tool("dup_suggest_extraction", "Suggest how to extract duplicated code into shared utilities (Pro feature)", {
