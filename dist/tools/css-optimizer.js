...
export function registerCssOptimizerTools(server) {
    server.tool("css_find_unused", "Find unused CSS selectors by comparing stylesheets against HTML/JSX content", {
            ...
            content: [
                {
                    ...
                    text: JSON.stringify({
                        ...
                        instructions: "Parse the CSS stylesheet and extract all selectors. Cross-reference each selector against the provided HTML/JSX content to identify selectors that are never used. Account for dynamic class names, state-based classes (hover, active, focus), and media query contexts. Report each unused selector with its line number and the full rule block, along with the estimated bytes that can be saved by removing it.",
                    }, null, 2),
                },
            ],
        };
    });
    server.tool("css_find_duplicates", "Find duplicate or overlapping CSS declarations and redundant rules", {
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            instructions: "This tool requires a Pro subscription. Upgrade to Pro to fully optimize your CSS with unused rule removal, duplicate merging, modern syntax upgrades, and minification.",
                        }, null, 2),
                    },
                ],
            };
