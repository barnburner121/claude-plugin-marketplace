...
export function registerGoScaffoldTools(server) {
    server.tool("scaffold_go_project", "Generate a Go project directory structure following standard layout conventions", {
    ...
    server.tool("generate_go_module", "Generate go.mod with curated dependencies for the project type", {
    ...
    server.tool("generate_go_handlers", "Generate HTTP handler boilerplate with middleware and routing (Pro feature)", {
