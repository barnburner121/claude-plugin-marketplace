...
export function registerRustCargoTools(server) {
    server.tool("generate_cargo_toml", "Generate a Cargo.toml with dependencies, features, and build profiles", {
    ...
    server.tool("setup_rust_workspace", "Configure a Cargo workspace with multiple crates", {
    ...
    server.tool("generate_rust_ci", "Generate CI/CD configuration for Rust projects (Pro feature)", {
