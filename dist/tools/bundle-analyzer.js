...
export function registerBundleAnalyzerTools(server) {
    server.tool("bundle_analyze_size", "Analyze JavaScript bundle size from package.json dependencies or build output", {
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            instructions: "This tool requires a Pro subscription. Upgrade to Pro to get a comprehensive bundle optimization plan with specific code changes, code splitting strategies, tree-shaking improvements, and build configuration updates.",
                        }, null, 2),
                    },
                ],
            };
