...
export function registerCommitLinterTools(server) {
    server.tool("commit_setup_conventional", "Set up conventional commit linting with commitlint configuration and rules", {
    ...
    server.tool("commit_setup_husky", "Configure Husky git hooks for commit message validation and pre-commit checks", {
    ...
    server.tool("commit_validate_history", "Validate and analyze existing commit history against conventional commit standards (Pro)", {
