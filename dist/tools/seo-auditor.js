...
export function registerSeoAuditorTools(server) {
    server.tool("seo_audit_meta", "Audit HTML meta tags, Open Graph, and structured data for SEO completeness", {
            ...
            content: [
                {
                    ...
                    text: JSON.stringify({
                        ...
                        instructions: "Analyze the HTML for SEO performance factors: heading hierarchy (single H1, proper nesting), image alt attributes and lazy loading, internal/external link quality, content length and keyword density, semantic HTML usage, mobile-friendliness indicators, render-blocking resources, and Core Web Vitals hints (large images, layout shift triggers, long tasks). Score each factor and provide an overall SEO health rating.",
                    }, null, 2),
                },
            ],
        };
    });
    server.tool("seo_generate_fixes", "Generate specific code fixes to resolve identified SEO issues (Pro)", {
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            instructions: "This tool requires a Pro subscription. Upgrade to Pro to automatically generate corrected HTML with all SEO issues fixed, including meta tags, structured data, and performance optimizations.",
                        }, null, 2),
                    },
                ],
            };
