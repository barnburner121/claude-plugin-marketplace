...
export function registerNodeExpressTools(server) {
    server.tool("scaffold_express_project", "Generate an Express.js project with TypeScript and best practices", {
    ...
    server.tool("generate_express_middleware", "Generate Express middleware for common concerns", {
    ...
    server.tool("generate_express_api_routes", "Generate RESTful API routes with validation and OpenAPI docs (Pro feature)", {
