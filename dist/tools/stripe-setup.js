...
export function registerStripeSetupTools(server) {
    server.tool("stripe_checkout_session", "Generate a Stripe Checkout session with line items, success/cancel URLs, and optional trial periods", {
    ...
    server.tool("stripe_subscription_manager", "Set up Stripe subscription lifecycle management with plan changes, cancellations, and proration", {
    ...
    server.tool("stripe_webhook_handler", "Generate a Stripe webhook handler with signature verification and event routing", {
