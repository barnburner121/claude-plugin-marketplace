...
export function registerPricingPageTools(server) {
    server.tool("pricing_table_component", "Generate a responsive pricing table component with plan comparison and feature lists", {
    ...
    server.tool("pricing_toggle", "Create a monthly/annual pricing toggle with animated price transitions", {
    ...
    server.tool("feature_comparison_matrix", "Generate a feature comparison matrix showing capabilities across plans", {
        framework: z.enum(["react", "vue", "svelte", "html"]).default("react"),
