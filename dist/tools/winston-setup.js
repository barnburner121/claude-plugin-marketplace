...
export function registerWinstonSetupTools(server) {
    server.tool("winston_logger_config", "Generate a Winston logger configuration with transports, formats, and log levels", {
    ...
    server.tool("winston_request_logger", "Create Express/Fastify request logging middleware using Winston with correlation IDs", {
    ...
    server.tool("winston_error_transport", "Set up a Winston transport for error alerting via email, Slack, or PagerDuty", {
