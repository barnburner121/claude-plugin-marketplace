...
export function registerCoverageAnalyzerTools(server) {
    server.tool("coverage_analyze_gaps", "Analyze code coverage data to identify untested code paths and coverage gaps", {
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            instructions: "This tool requires a Pro subscription. Upgrade to Pro to generate detailed coverage reports with trend analysis, threshold checks, and actionable insights.",
                        }, null, 2),
                    },
                ],
            };
            ...
            content: [
                {
                    ...
                    text: JSON.stringify({
                        ...
                        instructions: "Generate a comprehensive coverage report including overall metrics (line, branch, function, statement coverage), per-file breakdown, trend comparison with previous data, threshold pass/fail status, and actionable recommendations. Format as a markdown report suitable for CI/CD pipeline output or team review.",
                    }, null, 2),
                },
            ],
        };
