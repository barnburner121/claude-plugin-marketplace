...
export function registerDataGenTools(server) {
    server.tool("data_generate_from_schema", "Generate sample data from a JSON schema, TypeScript interface, or database schema", {
            ...
            content: [
                {
                    ...
                    text: JSON.stringify({
                        ...
                        instructions: "Parse the provided schema definition and generate sample data that conforms to all constraints (types, required fields, enums, min/max values, patterns). Generate the requested number of records with varied but valid values. Output in the specified format with proper structure and formatting.",
                    }, null, 2),
                },
            ],
        };
    });
    server.tool("data_generate_realistic", "Generate realistic fake data with contextually appropriate values (names, emails, addresses, etc.)", {
    ...
    server.tool("data_generate_edge_cases", "Generate edge case and boundary test data for stress testing (Pro)", {
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            instructions: "This tool requires a Pro subscription. Upgrade to Pro to generate edge case test data including unicode, overflow, injection, and boundary value scenarios.",
                        }, null, 2),
                    },
                ],
            };
