...
export function registerPinoSetupTools(server) {
    server.tool("pino_logger_config", "Generate a Pino logger configuration with serializers, redaction, and transport targets", {
    ...
    server.tool("pino_http_middleware", "Create pino-http middleware with request context propagation and custom serializers", {
    ...
    server.tool("pino_transport_pipeline", "Build a Pino transport pipeline with filtering, transformation, and multiple destinations", {
