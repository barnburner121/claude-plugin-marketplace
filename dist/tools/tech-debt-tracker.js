...
export function registerTechDebtTrackerTools(server) {
    server.tool("debt_scan_todos", "Scan codebase for TODO, FIXME, HACK, and other tech debt markers", {
    ...
    server.tool("debt_prioritize", "Analyze and prioritize tech debt items by impact and effort", {
    ...
    server.tool("debt_generate_report", "Generate a comprehensive tech debt report with metrics (Pro feature)", {
