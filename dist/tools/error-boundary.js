...
export function registerErrorBoundaryTools(server) {
    server.tool("error_generate_boundary", "Generate React error boundary components with recovery and retry logic", {
    ...
    server.tool("error_generate_fallback", "Generate fallback UI components for error states with user-friendly messaging", {
    ...
    server.tool("error_setup_reporting", "Set up error reporting and monitoring with Sentry, LogRocket, or custom solutions (Pro)", {
