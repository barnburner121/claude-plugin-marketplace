...
export function registerCloudflareWorkerTools(server) {
    server.tool("cf_generate_worker", "Generate a Cloudflare Worker script with routing, middleware, and environment bindings", {
    ...
    server.tool("cf_add_kv_storage", "Add Cloudflare KV namespace bindings and helper utilities to a Worker", {
    ...
    server.tool("cf_configure_routes", "Configure Worker routes, custom domains, and path-based routing (Pro)", {
        worker_name: z.string().describe("Worker name"),
