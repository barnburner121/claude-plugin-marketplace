...
export function registerUsageMeteringTools(server) {
    server.tool("usage_tracker", "Set up a real-time usage tracking system with counters, gauges, and histograms", {
    ...
    server.tool("usage_quota_enforcer", "Implement usage quota enforcement with soft and hard limits and overage handling", {
    ...
    server.tool("usage_dashboard_data", "Generate usage analytics data endpoints with aggregation and time-series queries", {
