...
export function registerUptimeSentinelTools(server) {
    // Tool 1: Generate health check endpoints
    server.tool("uptime_create_healthcheck", "Generate comprehensive health check endpoints for your application with dependency checks", {
        framework: z
    ...
    server.tool("uptime_create_monitors", "Generate monitoring configurations for uptime, SSL, and performance tracking", {
        endpoints: z
            .array(z.object({
            url: z.string(),
            name: z.string(),
    ...
    server.tool("uptime_create_status_page", "Generate a public status page for your services (Pro feature)", {
        services: z
            .array(z.object({
            name: z.string(),
    ...
    server.tool("uptime_create_runbook", "Generate incident response runbooks for common failure scenarios", {
        service_name: z.string().describe("Service name"),
        infrastructure: z
            .string()
            .describe("Infrastructure description (e.g., 'Node.js API on Railway with Postgres on Neon')"),
        common_issues: z
            .array(z.string())
            .optional()
